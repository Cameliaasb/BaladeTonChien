...
ActiveRecord::Schema[7.0].define(version: 2023_10_03_141712) do
  ...
  create_table "dogs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "neutered_males", default: false
    t.boolean "neutered_females", default: false
    t.boolean "unneutered_males", default: false
    t.boolean "unneutered_females", default: false
    t.boolean "small_dogs", default: false
    t.boolean "big_dogs", default: false
